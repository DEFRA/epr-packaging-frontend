...
namespace FrontendSchemeRegistration.UI.Extensions
{
    ...
    {
        internal static (IList<ComplianceSchemePaymentCalculationResponseMember> largeProducers, IList<ComplianceSchemePaymentCalculationResponseMember> smallProducers) GetIndividualProducers(
            this List<ComplianceSchemePaymentCalculationResponseMember> complianceSchemeMembers, List<ComplianceSchemeDetailsMemberDto> csoMembershipDetails)
        {
            ...
            foreach (var csoMembershipDetail in csoMembershipDetails)
            {
                ...
                var complianceSchemeMember = complianceSchemeMembers
                    .Find(r => r.MemberId == csoMembershipDetail.MemberId && r.MemberRegistrationFee > 0);

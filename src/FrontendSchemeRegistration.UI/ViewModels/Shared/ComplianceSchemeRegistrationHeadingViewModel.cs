...
/// </summary>
public record class ComplianceSchemeRegistrationHeadingViewModel(bool ShowRegistrationCaption, RegistrationJourney? RegistrationJourney, string? Heading, LocalizedHtmlString? LocalizedHeading, int RegistrationYear);